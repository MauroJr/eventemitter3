...
[ee1, ee2, ee3, master, drip, ee, ce, fne].forEach(function ohai(emitter) {
...
new benchmark.Suite()
  .add("funcEmitter", function() {
    fne.emit("foo");
    fne.emit("foo", "bar");
    fne.emit("foo", "bar", "baz");
    fne.emit("foo", "bar", "baz", "boom");
  })
